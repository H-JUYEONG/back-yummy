...
import com.javaex.user.service.JuKakaoService;
...
@RestController
public class JuKakaoLoginController {

	@Autowired
	private JuUserService juUserService;

	@Autowired
	private JuKakaoService juKakaoService;
	...
	@GetMapping("/api/users/kakao/profile")
	public JsonResult getUserInfo(@RequestHeader("Authorization") String authHeader, HttpServletResponse response,
		...
		try {
			...
			JuUserVo userInfo = juKakaoService.getKakaoUserProfile(authHeader);
